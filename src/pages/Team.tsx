        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <ul className="space-y-4">
              {['We embrace both data science and creative intuition', 'We prioritize impact over industry conventions', 'We believe in transparency with our team and clients', "We're committed to ethical AI and responsible marketing"].map((item, index) => <li key={index} className="flex items-start">
          ...
          <div className="relative">
            ...
            <div className="relative bg-furi-charcoal-dark p-6 rounded-lg">
              <img src="https://images.unsplash.com/photo-1519389950473-47ba0277781c" alt="Team Culture" className="rounded-lg w-full h-auto" />
            </div>
          </div>
        </div>
      </section>
